...
const Index = () => {
  ...
  const currentImage = useSelector((state) => state.hero.currentImage);
  const isOpen = useSelector((state) => state.hero.isOpen);
    ...
    <div className="home-container">
      ...
      <nav className="navbar">
        <div className="navbar-logo">
          <img src={logo} alt="St. Martin Logo" loading="lazy" />
          <span></span>
        </div>
      ...
      <div className={`sidebar ${isOpen ? "active" : ""}`}>
        <button className="close-btn" onClick={() => dispatch(toggleMenu())}>
          ×
        </button>
      ...
      <section className="events-section">
        ...
        <div className="event-card">
          ...
          <p>
            ...
            ensuring every detail is crafted to perfection. From intimate
      ...
      >
        ...
        <div className="floral-content">
          ...
          <p className="floral-quote">
            “spreading love to your loved ones by sending them a lovely gift
            which they admire the most.”
          </p>
          <p className="floral-desc">
            Giving a glorious and heavenly ambience on your amazing day with
            original imported floral accessories.
          </p>
      ...
      <section className="featured-services">
        ...
        <div className="service-box">
          ...
          <img src={DecorationImage1} alt="Decoration" loading="lazy" />
          <img src={DecorationImage2} alt="Decoration" loading="lazy" />
        </div>

        {/* Middle Column - Bridal Image */}
        <div className="service-image">
          <img src={BridalImage1} alt="Bridal" loading="lazy" />
        ...
        <div className="service-box">
          ...
          <img src={EventsImage1} alt="Custom Events" loading="lazy" />
          <img src={EventsImage2} alt="Custom Events" loading="lazy" />
        </div>
      </section>
